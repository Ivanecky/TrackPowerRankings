...
# Create list of URLs
urls <- c(indoorD117, indoorD118, indoorD119, indoorD120, indoorD121, indoorD217, indoorD218, indoorD219, indoorD220, indoorD221, indoorD317, indoorD318, indoorD319, indoorD320, indoorD321,
          indoorD111, indoorD112, indoorD113, indoorD114, indoorD115, indoorD116, indoorD211, indoorD212, indoorD213, indoorD214, indoorD215, indoorD216, indoorD311, indoorD312, indoorD313, 
          indoorD314, indoorD315, indoorD316)
...
dbCreateTable(aws, "runners_grouped", df_format)
dbWriteTable(aws, "runners_grouped", df_format, append = TRUE)
...
# temp <- read_html(indoorD221) %>%
#   html_table()
# 
# results <- as.data.frame(temp[7])
# 
# # Subset
# results <- results %>%
#   select(ATHLETE, TIME) %>%
